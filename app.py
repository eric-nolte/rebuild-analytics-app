    ...
    for ws in workbook.worksheets:
        ...
        for col_idx, header in header_map.items():
            ...
            for cell in ws[col_letter][1:]:
                ...
                elif any(keyword in header for keyword in percent_keywords) and "RATE" in header:
...
**V15.4 addition:** The Machine Detail tab includes a single-machine workbook export with machine summary, rebuild cost summaries, adjusted cost impact, raw data, dealer performance, region performance, exceptions, methodology, CPI, and FX references.""")
